...
namespace InstaPrep.Data
{
    public class SeedIngredients
    {
        ...
        public void SeedData(InstaPrepContext context, List<Recipe>? recipes)
        {
            ...
            foreach(var recipe in recipes)
            {
                foreach(var ingredient in recipe.IngredientsList)
                {
                    ...
                    allIngredients[allIngredients.Count()-1].RecipeId = recipe.Id;
                    
                }
            }

            context.RecipeIngredient.AddRange(allIngredients);
